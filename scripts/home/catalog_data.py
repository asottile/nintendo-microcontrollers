...
Gender = enum.Enum('Gender', 'MALE FEMALE GENDERLESS')
...
def get_ball(img: numpy.ndarray) -> str | None:
...
def main() -> int:
    ...
    for i in range(max_n + 1):
        img = cv2.imread(os.path.join(args.imgs, f'{i:04}.png'))
        ...
        print(f'{i:04}, {species}, {level}, {stats}')
